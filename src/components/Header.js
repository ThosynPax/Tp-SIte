        ...
        <div className={`mobile-menu ${isMenuOpen ? 'active' : ''}`}>
          ...
          <nav>
            <ul>
              ...
              <li><a href="https://thosynpax.com/prodsculpt/" rel="noreferrer" target="_blank" onClick={toggleMenu}>ProdSculpt</a></li>
              <li><a href="https://afribreath.com/community/mentorship/" rel="noreferrer" target="_blank" onClick={toggleMenu}>TPM Mentoring</a></li>
